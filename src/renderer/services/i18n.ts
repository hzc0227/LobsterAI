...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authQuotaExhausted: '今日免费额度已用完。您可以登录 JdiClaw Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'JdiClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 JdiClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 JdiClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'JdiClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkConfigSaveFailed: '保存 JdiClaw 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'JdiClaw 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'JdiClaw 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    skillRequestAction: '发布需求',
    skillRequestDialogTitle: '发布技能诉求',
    skillRequestDialogDescription: '描述你期望 AI 具备的能力，或你日常重复在做但希望自动化的工作。我们会结合您的诉求开放定制化能力。',
    skillRequestPlaceholder: '例如：每周自动整理项目周报、批量汇总多份表格、按固定模板生成复盘文档。',
    skillRequestSubmit: '提交',
    skillRequestSubmitting: '提交中...',
    skillRequestSubmitSuccess: '已收到您的诉求，我们会结合您的诉求开放定制化能力',
    skillRequestSubmitFailed: '提交诉求失败，请稍后重试',
    skillRequestEmpty: '请输入你的技能诉求',
    skillRequestTooLong: '诉求内容不能超过 {count} 字',
    skillRequestLoginHint: '请先完成登录，再继续提交诉求',
    skillRequestCurrentErp: '当前用户：{erp}',
    skillRequestEmptyStateTitle: '没找到合适技能？',
    skillRequestEmptyStateDescription: '你可以描述想要的能力或重复工作，我们会针对对应角色评估并定制技能。',
    skillMarketplaceLoginRequiredTitle: '登录后可查看技能市场',
    skillMarketplaceLoginRequiredDescription: '技能市场会根据你的 ERP 身份返回可见技能，请先完成登录。',
    skillMarketplaceLoginAction: '立即登录',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'JdiClaw 服务协议',
    privacyDialogDesc: '在使用 JdiClaw 之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'JdiClaw 服务协议',
  ...
  en: {
    ...
    copied: 'Copied',
    copyrightHolder: 'JdiClaw. All rights reserved.',
    ...
    authQuotaExhausted: 'Daily free quota exhausted. Visit JdiClaw Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    authTopUpLink: 'Top Up',
    authSettingsLink: 'Settings',
    authLoginToChat: 'Log in to start chatting',
    authErpLabel: 'Current ERP',
    authFreeLabel: 'Free',
    ...
    // JdiClaw
    cowork: 'JdiClaw',
    coworkSettings: 'JdiClaw Settings',
    ...
    coworkWorkingDirectoryHint: 'JdiClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for JdiClaw...',
    coworkSystemPromptHint: 'Optional system prompt to customize JdiClaw\'s behavior',
    ...
    coworkModelSettingsHint: 'JdiClaw uses the current model and provider configuration from Model Settings.',
    ...
    coworkConfigSaveFailed: 'Failed to save JdiClaw settings. Please try again.',
    ...
    coworkPermissionDescription: 'JdiClaw is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'JdiClaw needs your input',
    ...
    skillRequestAction: 'Publish Request',
    skillRequestDialogTitle: 'Publish Skill Request',
    skillRequestDialogDescription: 'Describe the capability you want AI to have, or the repetitive work you hope to automate. We will use your request to open up tailored capabilities.',
    skillRequestPlaceholder: 'For example: generate weekly project reports, batch summarize spreadsheets, or create review documents from a fixed template.',
    skillRequestSubmit: 'Submit',
    skillRequestSubmitting: 'Submitting...',
    skillRequestSubmitSuccess: 'Your request has been received. We will use it to open up tailored capabilities.',
    skillRequestSubmitFailed: 'Failed to submit the request. Please try again later.',
    skillRequestEmpty: 'Please enter your skill request',
    skillRequestTooLong: 'The request must be within {count} characters',
    skillRequestLoginHint: 'Please complete login before submitting the request',
    skillRequestCurrentErp: 'Current user: {erp}',
    skillRequestEmptyStateTitle: 'Cannot find the right skill?',
    skillRequestEmptyStateDescription: 'Describe the capability or repetitive work you need, and we will evaluate a tailored skill for the matching role.',
    skillMarketplaceLoginRequiredTitle: 'Login required for Marketplace',
    skillMarketplaceLoginRequiredDescription: 'The skills marketplace uses your ERP identity to decide which skills are visible. Please sign in first.',
    skillMarketplaceLoginAction: 'Log in',
    ...
    // Privacy dialog
    privacyDialogTitle: 'JdiClaw Terms of Service',
    privacyDialogDesc: 'Before using JdiClaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'JdiClaw Terms of Service',
